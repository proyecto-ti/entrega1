    ...
    def post(self, request):
        ...
        if sku in inventario.keys():
            ...
            if envio.status_code == 200:
                ...
                return Response(data="error de nuestro grupo. Oops!", status=status.HTTP_400_BAD_REQUEST)
        else:
            return Response(data="Producto no se encuentra", status=status.HTTP_404_NOT_FOUND)
